            ...
            <div style={{ minWidth: 200, textAlign: "center" }}>
                ...
                <div style={{ color: "white", marginBottom: 10 }}>
                    <Button.Group>
                        ...
                        {this.hasNext ? (
                            <Button>
                                Page {this.page + 1} of {pages.length}
                            </Button>
                        ) : (
...
const pages = [
    ...
    () => (
        <Segment>
            ...
            <p>
                You can enable or disable the extension per board by clicking the little icon at the
                top of the board:
            </p>
    ...
    () => (
        <Segment>
            ...
            <p>
                Click the Chat for Trello icon to the right of your address bar in chrome to access
                the settings button
            </p>
