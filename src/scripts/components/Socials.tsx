...
export class Socials extends React.Component<Props, {}>
{
    render() {
        ...
        return <React.Fragment>
            ...
            <SocialButton href="mailto:mike.cann@gmail.com?Subject=Chat%20For%20Trello" icon="mail" />
            <SocialButton href="http://mikecann.co.uk" icon="internet explorer" />
            <SocialButton href="http://facebook.com/mikeysee" icon="facebook" />
            { !small ? <SocialButton href="https://secure.skype.com/portal/overview?skypename=cannyshammy" icon="skype" /> : null }
            { !small ? <SocialButton href="https://www.youtube.com/channel/UC9-RJld8R0v5ywwBT8csdZA" icon="youtube" /> :  null }
        </React.Fragment> 
    }
}
