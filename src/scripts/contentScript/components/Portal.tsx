...
{
    render() {
        var mountContainer = this.props.queryEl.querySelector(this.props.querySelector) as HTMLElement | undefined;
        if (!mountContainer) {
            this.props.logger!.debug(`Portal cannot render. Could not find the required elemnt, selector: ${this.props.querySelector}`)
            return "";
        }
