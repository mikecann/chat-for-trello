...
export class CancelMembershipModal extends React.Component<Props, {}>
{
    ...
    render() {
        ...
        <Modal.Content>
            <Modal.Description>
                <p>You can cancel your membership subscription at any time via the Google Payments Centre.</p>
                <p>It may take up to 48 hours before the cancellation is reflected in the extension</p>
