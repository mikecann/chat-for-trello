...
import { Segment, Button, Header, Icon, Grid, Card, Image, Label, List, Modal } from 'semantic-ui-react';
    ...
    render() {
        ...
        return <React.Fragment>
            <Segment style={{ textAlign: "center" }}>
                ...
                <p>Thankyou so much for becoming a Chat for Trello Premium Member. Your continued support goes a long way towards helping me continue to improve this extension. Please feel free to leave me an message or suggestion on <a href="https://trello.com/b/Mdpd40Tt">our trello board</a>, or email me directly at any time if you have questions: <a href="mailto:mike@cannstudios.com">mike@cannstudios.com</a>.    </p>
                <p>As a Chat for Trello Premium member you now have full access to the following:</p>
            ...
            <Segment style={{ textAlign: "center" }}>
                <Header as="h3">
                    Want To Cancel?
            <Header.Subheader>I would hate to see you go, but I think its important that you can cancel at any time.</Header.Subheader>
                </Header>
                <Button basic color="red" onClick={this.onCancelClicked}>Cancel my Membership</Button>
            </Segment>
            <CancelMembershipModal isOpen={this.cancelMembershipIsOpen} onClose={this.hideCancelMembershipModal} />
        </React.Fragment>
    }
}
    ...
    render() {
        ...
        return <React.Fragment>
            <Segment style={{ textAlign: "center" }}>
                <Header as="h1">Chat for Trello Premium Membership</Header>
                <div>
                    Become a premium member today and get access to all these awesome additional features:
                </div>
                <div style={{ display: "flex", marginTop: 20, justifyContent: "center" }}>
                    <PremiumFeaturesList />
                </div>
            ...
            {auth.isAuthenticated ? null : <LoginSegment isLoading={auth.isLoading} onLogin={this.login} />}
            <StartFreeTrialModal isOpen={this.freeTrialModalIsOpen} onClose={this.hideFreeTrialModal} />
            <StartPremiumModal isOpen={this.premiumModalIsOpen} onClose={this.hidePremiumModal} />
            <CancelMembershipModal isOpen={this.cancelMembershipIsOpen} onClose={this.hideCancelMembershipModal} />
        </React.Fragment>
    }
}
...
const LoginSegment = (props: { isLoading: boolean, onLogin: () => void }) =>
    <Segment style={{ textAlign: "center" }}>
        <Header as="h3">
            Already a Member?
            <Header.Subheader>Are you already a premium member and need to login, no worries</Header.Subheader>
        </Header>
        <Button loading={props.isLoading} primary onClick={props.onLogin}>Login</Button>
    </Segment>
...
const FreeTrialCard = (props: { daysRemain: number, isOnFreeTrial: boolean, onClick: () => void, onCancelClick: () => void }) =>
    <div style={{ position: "relative" }}>
        {props.isOnFreeTrial ? <FreeTrialCardLabel isExpired={false} daysRemain={props.daysRemain} /> : null}
        <Card onClick={props.isOnFreeTrial ? undefined : props.onClick} style={{
            textAlign: "center",
            opacity: 1,
            marginTop: 0
        }}>
            ...
            <Card.Content>
                ...
                <Card.Description>Get all the benefits of the Premium Subscription free for 30 days!</Card.Description>
...
const FreeTrialCardLabel = (props: { isExpired: boolean, daysRemain: number }) => {
    if (props.isExpired)
        return <Label color='red' attach="top" style={{ position: "absolute", textAlign: "center", zIndex: 10, width: "100%" }}>
            Expired
        </Label>

    return <Label color='orange' attach="top" style={{ position: "absolute", textAlign: "center", zIndex: 10, width: "100%" }}>
...
const PremiumSubscriptionCard = (props: { onClick: () => void }) =>
    <Card style={{ textAlign: "center" }} onClick={props.onClick}>
        ...
        <Card.Content>
            ...
            <Card.Description>All of the awesome additional features, can cancel at any time!</Card.Description>
        </Card.Content>
    </Card>